...
#define GIT_COMMIT_ID "cc2146f5590c403c235ad1efcd6b7fc99fea4ddd"
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (copyright_devs.find("Bitcoin FAFO") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Bitcoin Vibe developers";
    }
...
std::string LicenseInfo()
{
    ...
    return CopyrightHolders(strprintf(_("Copyright (C) %i-%i").translated, 2009, COPYRIGHT_YEAR) + " ") + "\n" +
           ...
           "\n" +
           "\n" +
           _("This is fucked up software.").translated + "\n" +
